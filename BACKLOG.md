...
- Free-result comprehension pass: human explanation for Four Transformations and the 12 Zi Wei palaces, accessible local palace disclosures, explicit continuation to the current life period, and a calm existing-flow Premium bridge. Mobile double-spacing after the palace map was removed; calculated palace ages remain unchanged.
