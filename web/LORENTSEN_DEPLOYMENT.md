...
9. До первого платежа решить с Lorentsen, остаётся ли публичное имя партнёра `Edward` или меняется на `Тянь Мин`, и установить подтверждённое имя в `LORENTSEN_PARTNER_PUBLIC_NAME`.
